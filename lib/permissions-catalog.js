...
const NAV_DEFAULTS = {
  ...
  '/reservations.html': ['admin', 'manager'],
  '/rentacar-site-editor.html': ['admin', 'manager'],
...
const ACTION_MODULES = [
  ...
  {
    key: 'reservations',
    label: 'Резервации (сайт под наем)',
    actions: [
      { key: 'view', label: 'Преглед на резервации/календар', defaultRoles: ['admin', 'manager'] },
      { key: 'manage', label: 'Потвърждаване/отказ/нова резервация', defaultRoles: ['admin', 'manager'] },
    ],
  },
  {
    key: 'rentacar_site',
    label: 'Начална страница на Dombi Rent-a-Car (нов сайт)',
    actions: [
      { key: 'manage', label: 'Редакция на съдържанието', defaultRoles: ['admin', 'manager'] },
    ],
  },
  {
    key: 'nav_settings',
